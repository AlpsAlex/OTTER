...
bool initGLFW() {
	...
	window = glfwCreateWindow(800, 800, "Jingyao Zhang 100697498", nullptr, nullptr);
...
int main() {
	...
	static const GLfloat points[] = {
		//X, Y, Z
		-1.0f, -0.5f, 0.5f, //vert1
		0.0f, -0.5f, 0.5f, //vert2
		-0.5f, 0.5f, 0.5f, //vert3
		0.0f, -0.5f, 0.5f, //vert1
		1.0f, -0.5f, 0.5f, //vert2
		1.0f, 0.5f, 0.5f, //vert3
		0.0f, 0.5f, 0.5f //vert4
	};
